DROP TABLE IF EXISTS student_da;
CREATE TABLE student_da
(
...
INSERT INTO student_da(
	section, last_name, first_name, full_name, work_email, work_phone, book_preference)
	VALUES 
	('Niteen','BETANCOURT','MARIE','Aukia Betancourt','Aukia.Betancourt@nychhc.org','(212) 562-3165','Physical Copy'),
('Niteen','Goicochea-Creamer','Carla','Carla Goicochea-Creamer','goicochc2@nychhc.org','(646) 4582058','Physical Copy'),
('Niteen','Lee','Chris','Chris Lee','Christopher.Lee@nychhc.org','(212) 848-5810','Digital Copy'),
('Niteen','','','Cloie Velasco','velascoc@nychhc.org','(718) 8833610','Digital Copy'),
